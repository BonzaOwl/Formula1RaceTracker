<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit-circuit.aspx.cs" Inherits="FormulaOneWebApp.administration.edit_circuit" %>
                        ...
                        <div class="col-md-12 order-md-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:dropdownlist ID="x_circuit_city" runat="server" CssClass="form-control" AutoPostBack="true"></asp:dropdownlist>
                                    <asp:Label ID="x_city_validation" runat="server"></asp:Label>
                                </div>
                            </div>

                            <hr class="mb-4">
                            <asp:Button ID="x_save_btn" runat="server" CssClass="btn btn-primary btn-lg btn-block" Text="Save Details" />
                        </div>
                    </div>
